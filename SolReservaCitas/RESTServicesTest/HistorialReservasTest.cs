    ...
    public class HistorialReservasTest
    {
        ...
        public void TestListar()
        {
            HttpWebRequest req2 = (HttpWebRequest)WebRequest
                .Create("http://localhost:5001/Implementacion/HistorialReservasService.svc/Historias/09392641/2014-01-01/2014-01-31");
            req2.Method = "GET";
        ...
        [TestMethod]
        public void TestListarErrorAfiliado()
        {
            HttpWebRequest req2 = (HttpWebRequest)WebRequest
                .Create("http://localhost:5001/Implementacion/HistorialReservasService.svc/Historias/0000001/2013-01-01/2013-01-31");
            req2.Method = "GET";
            HttpWebResponse res2 = null;
            try
            {
            ...
            { 
                ...
                JavaScriptSerializer js3 = new JavaScriptSerializer();
                string errorMessage = js3.Deserialize<string>(error2);
                Assert.AreEqual("Afiliado No Registrado.", errorMessage);
