...
namespace WebReservaCitasAfiliado.WSAfiliado {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="WSAfiliado.IAfiliado")]
    public interface IAfiliado {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(WebReservaCitasAfiliado.WSAfiliado.Error), Action="http://tempuri.org/IAfiliado/CrearAfiliadoErrorFault", Name="Error", Namespace="http://schemas.datacontract.org/2004/07/SOAPServices.Dominio")]
        WebReservaCitasAfiliado.WSAfiliado.Afiliado CrearAfiliado(string dni, string nombre, string apepaterno, string apematerno, string direccion, System.DateTime fechaNacimiento, int estado);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAfiliado/CrearAfiliado", ReplyAction="http://tempuri.org/IAfiliado/CrearAfiliadoResponse")]
        System.Threading.Tasks.Task<WebReservaCitasAfiliado.WSAfiliado.Afiliado> CrearAfiliadoAsync(string dni, string nombre, string apepaterno, string apematerno, string direccion, System.DateTime fechaNacimiento, int estado);
        ...
        WebReservaCitasAfiliado.WSAfiliado.Afiliado ObtenerAfiliado(int idAfiliado);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAfiliado/ObtenerAfiliado", ReplyAction="http://tempuri.org/IAfiliado/ObtenerAfiliadoResponse")]
        System.Threading.Tasks.Task<WebReservaCitasAfiliado.WSAfiliado.Afiliado> ObtenerAfiliadoAsync(int idAfiliado);
        ...
        WebReservaCitasAfiliado.WSAfiliado.Afiliado ModificarAfiliado(int idAfiliado, string dni, string nombre, string apepaterno, string apematerno, string direccion, System.DateTime fechaNacimiento, int estado);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAfiliado/ModificarAfiliado", ReplyAction="http://tempuri.org/IAfiliado/ModificarAfiliadoResponse")]
        System.Threading.Tasks.Task<WebReservaCitasAfiliado.WSAfiliado.Afiliado> ModificarAfiliadoAsync(int idAfiliado, string dni, string nombre, string apepaterno, string apematerno, string direccion, System.DateTime fechaNacimiento, int estado);
        ...
        WebReservaCitasAfiliado.WSAfiliado.Afiliado[] ListarAfiliado();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAfiliado/ListarAfiliado", ReplyAction="http://tempuri.org/IAfiliado/ListarAfiliadoResponse")]
        System.Threading.Tasks.Task<WebReservaCitasAfiliado.WSAfiliado.Afiliado[]> ListarAfiliadoAsync();
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(WebReservaCitasAfiliado.WSAfiliado.Error), Action="http://tempuri.org/IAfiliado/ValidarDNIExistenteReniecErrorFault", Name="Error", Namespace="http://schemas.datacontract.org/2004/07/SOAPServices.Dominio")]
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAfiliadoChannel : WebReservaCitasAfiliado.WSAfiliado.IAfiliado, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AfiliadoClient : System.ServiceModel.ClientBase<WebReservaCitasAfiliado.WSAfiliado.IAfiliado>, WebReservaCitasAfiliado.WSAfiliado.IAfiliado {
        ...
        public WebReservaCitasAfiliado.WSAfiliado.Afiliado CrearAfiliado(string dni, string nombre, string apepaterno, string apematerno, string direccion, System.DateTime fechaNacimiento, int estado) {
            return base.Channel.CrearAfiliado(dni, nombre, apepaterno, apematerno, direccion, fechaNacimiento, estado);
        }
        
        public System.Threading.Tasks.Task<WebReservaCitasAfiliado.WSAfiliado.Afiliado> CrearAfiliadoAsync(string dni, string nombre, string apepaterno, string apematerno, string direccion, System.DateTime fechaNacimiento, int estado) {
            return base.Channel.CrearAfiliadoAsync(dni, nombre, apepaterno, apematerno, direccion, fechaNacimiento, estado);
        }
        
        public WebReservaCitasAfiliado.WSAfiliado.Afiliado ObtenerAfiliado(int idAfiliado) {
            return base.Channel.ObtenerAfiliado(idAfiliado);
        }
        
        public System.Threading.Tasks.Task<WebReservaCitasAfiliado.WSAfiliado.Afiliado> ObtenerAfiliadoAsync(int idAfiliado) {
            return base.Channel.ObtenerAfiliadoAsync(idAfiliado);
        }
        
        public WebReservaCitasAfiliado.WSAfiliado.Afiliado ModificarAfiliado(int idAfiliado, string dni, string nombre, string apepaterno, string apematerno, string direccion, System.DateTime fechaNacimiento, int estado) {
            return base.Channel.ModificarAfiliado(idAfiliado, dni, nombre, apepaterno, apematerno, direccion, fechaNacimiento, estado);
        }
        
        public System.Threading.Tasks.Task<WebReservaCitasAfiliado.WSAfiliado.Afiliado> ModificarAfiliadoAsync(int idAfiliado, string dni, string nombre, string apepaterno, string apematerno, string direccion, System.DateTime fechaNacimiento, int estado) {
        ...
        public WebReservaCitasAfiliado.WSAfiliado.Afiliado[] ListarAfiliado() {
            return base.Channel.ListarAfiliado();
        }
        
        public System.Threading.Tasks.Task<WebReservaCitasAfiliado.WSAfiliado.Afiliado[]> ListarAfiliadoAsync() {
