...
namespace RESTServices.WSAfiliado {
    ...
    public interface IAfiliado {
        ...
        RESTServices.WSAfiliado.Afiliado CrearAfiliado(string dni, string nombre, string apepaterno, string apematerno, string direccion, System.DateTime fechaNacimiento, int estado);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAfiliado/CrearAfiliado", ReplyAction="http://tempuri.org/IAfiliado/CrearAfiliadoResponse")]
        System.Threading.Tasks.Task<RESTServices.WSAfiliado.Afiliado> CrearAfiliadoAsync(string dni, string nombre, string apepaterno, string apematerno, string direccion, System.DateTime fechaNacimiento, int estado);
        ...
        RESTServices.WSAfiliado.Afiliado ObtenerAfiliado(int idAfiliado);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAfiliado/ObtenerAfiliado", ReplyAction="http://tempuri.org/IAfiliado/ObtenerAfiliadoResponse")]
        System.Threading.Tasks.Task<RESTServices.WSAfiliado.Afiliado> ObtenerAfiliadoAsync(int idAfiliado);
        ...
        RESTServices.WSAfiliado.Afiliado ModificarAfiliado(int idAfiliado, string dni, string nombre, string apepaterno, string apematerno, string direccion, System.DateTime fechaNacimiento, int estado);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAfiliado/ModificarAfiliado", ReplyAction="http://tempuri.org/IAfiliado/ModificarAfiliadoResponse")]
        System.Threading.Tasks.Task<RESTServices.WSAfiliado.Afiliado> ModificarAfiliadoAsync(int idAfiliado, string dni, string nombre, string apepaterno, string apematerno, string direccion, System.DateTime fechaNacimiento, int estado);
        ...
        RESTServices.WSAfiliado.Afiliado[] ListarAfiliado();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAfiliado/ListarAfiliado", ReplyAction="http://tempuri.org/IAfiliado/ListarAfiliadoResponse")]
        System.Threading.Tasks.Task<RESTServices.WSAfiliado.Afiliado[]> ListarAfiliadoAsync();
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAfiliadoChannel : RESTServices.WSAfiliado.IAfiliado, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AfiliadoClient : System.ServiceModel.ClientBase<RESTServices.WSAfiliado.IAfiliado>, RESTServices.WSAfiliado.IAfiliado {
        ...
        public RESTServices.WSAfiliado.Afiliado CrearAfiliado(string dni, string nombre, string apepaterno, string apematerno, string direccion, System.DateTime fechaNacimiento, int estado) {
            return base.Channel.CrearAfiliado(dni, nombre, apepaterno, apematerno, direccion, fechaNacimiento, estado);
        }
        
        public System.Threading.Tasks.Task<RESTServices.WSAfiliado.Afiliado> CrearAfiliadoAsync(string dni, string nombre, string apepaterno, string apematerno, string direccion, System.DateTime fechaNacimiento, int estado) {
            return base.Channel.CrearAfiliadoAsync(dni, nombre, apepaterno, apematerno, direccion, fechaNacimiento, estado);
        }
        
        public RESTServices.WSAfiliado.Afiliado ObtenerAfiliado(int idAfiliado) {
            return base.Channel.ObtenerAfiliado(idAfiliado);
        }
        
        public System.Threading.Tasks.Task<RESTServices.WSAfiliado.Afiliado> ObtenerAfiliadoAsync(int idAfiliado) {
            return base.Channel.ObtenerAfiliadoAsync(idAfiliado);
        }
        
        public RESTServices.WSAfiliado.Afiliado ModificarAfiliado(int idAfiliado, string dni, string nombre, string apepaterno, string apematerno, string direccion, System.DateTime fechaNacimiento, int estado) {
            return base.Channel.ModificarAfiliado(idAfiliado, dni, nombre, apepaterno, apematerno, direccion, fechaNacimiento, estado);
        }
        
        public System.Threading.Tasks.Task<RESTServices.WSAfiliado.Afiliado> ModificarAfiliadoAsync(int idAfiliado, string dni, string nombre, string apepaterno, string apematerno, string direccion, System.DateTime fechaNacimiento, int estado) {
        ...
        public RESTServices.WSAfiliado.Afiliado[] ListarAfiliado() {
            return base.Channel.ListarAfiliado();
        }
        
        public System.Threading.Tasks.Task<RESTServices.WSAfiliado.Afiliado[]> ListarAfiliadoAsync() {
